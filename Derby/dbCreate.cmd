...
connect 'jdbc:derby:JavaTunesDB2;create=true;user=guest;password=password';

connect 'jdbc:derby://localhost:1527/JavaTunesDB3;create=true;user=guest;password=password';